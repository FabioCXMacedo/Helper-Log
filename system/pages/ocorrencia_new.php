    ...
    <div>
        <?php 
            ...
            echo voltar();
                    ...
                    $q = "INSERT INTO ocorrencias (tipo, descricao, valor, id_viagem, id_veiculo, id_motorista, id_user, observacao, anexo, situacao) VALUES ('$tipo', '$descricao', '$valor', '$id_viagem' , '$veiculo', '$motorista','$usuario',  '$observacao', '$caminhoDestino', 'Conferir')";
