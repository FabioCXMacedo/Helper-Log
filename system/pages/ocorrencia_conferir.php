        ...
        <?php 
            ...
            echo msg_erro('Área restrita. Você não é administrador!');
                ...
                if (isset($_GET['id'])) {
                    ...
                    $q = "UPDATE ocorrencias SET situacao = 'Conferida' WHERE id = $id";

                    try {
                        if ($banco->query($q)) {
                            echo msg_sucesso("Ocorrência conferida com sucesso!");
                            echo "
                                <div class='container'>
                        ...
                        echo "<p>Não foi possível conferir a ocorrência. Tente novamente! " . $e->getMessage() . "</p>";
                        echo "
                            <div class='container'>
                                <a href='ocorrencias.php'>
                                    <input type='submit' value='Voltar' class='btn btn-outline-primary'>
