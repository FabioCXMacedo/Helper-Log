        ...
        if (!is_admin()) {
            ...
            echo "
                <div class='content checklist'>
                    <form action='contas_pagar_pagar.php?id=$id>' method='post'>
                        <div class='row mb-4 g-4'>
                            ...
                            <div class='col-6 check-form'>
                                ...
                                <input type='text' class='form-control' id='tipo' name='tipo' value=' $reg->tipo_despesa' readonly>
                            </div>
                            <div class='col-3 check-form'>
                                <label for='placa1' class='form-label'>Veículo</label>
                                <input type='text' class='form-control' id='veiculo' name='veiculo' value='$reg->veiculo' readonly>
                            </div>
                            <div class='col-3 check-form'>
                                <label for='motorista' class='form-label'>Motorista</label>
                                <input type='text' class='form-control' id='motorista' name='motorista' value='$reg->motorista' readonly>
                            </div>
                            <div class='col-12 check-form'>
                            ...
                            <div class='col-6 check-form'>
                                <label for='valor-pago' class='form-label'>Valor Pago</label>
