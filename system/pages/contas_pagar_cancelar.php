        ...
        <?php 
            ...
            echo msg_erro('Área restrita. Você não é administrador!');
                ...
                if (isset($_GET['id'])) {
                    ...
                    $q = "UPDATE contas_pagar SET situacao = 'Cancelada' WHERE id = $id";

                    try {
                        if ($banco->query($q)) {
                            echo msg_sucesso("Conta excluída com sucesso!");
                            echo "
                                <div class='container'>
                        ...
                        echo "<p>Não foi possível excluir a conta. Tente novamente! " . $e->getMessage() . "</p>";
                        echo "
                            <div class='container'>
                                <a href='contas_pagar.php'>
                                    <input type='submit' value='Voltar' class='btn btn-outline-primary'>
