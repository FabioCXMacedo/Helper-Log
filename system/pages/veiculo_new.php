    ...
    <div>
        <?php 
            ...
            echo msg_erro('Área restrita. Você não é administrador!');
                    ...
                    $q = "INSERT INTO veiculos (descricao, placa1, placa2, ano_fab, modelo, kilometragem, troca_oleo, p_troca_oleo, alerta_troca_oleo, troca_bronzina, p_troca_bronzina, alerta_troca_bronzina, pneu1, pneu2, pneu3, pneu4, pneu5, pneu6, pneu7, pneu8, pneu9, pneu10, pneu11, pneu12, pneu13, pneu14, pneu15, pneu16, pneu17, pneu18, pneu19, pneu20, pneu21, pneu22) VALUES ('$descricao', '$placa1', '$placa2', '$ano_fab', '$modelo', '$kilometragem', '$troca_oleo', '$ptroca_oleo', '$alerta_troca_oleo', '$troca_bronzina', '$ptroca_bronzina',  '$alerta_troca_bronzina', '$pneu1', '$pneu2', '$pneu3', '$pneu4', '$pneu5', '$pneu6', '$pneu7', '$pneu8', '$pneu9', '$pneu10', '$pneu11', '$pneu12', '$pneu13', '$pneu14', '$pneu15', '$pneu16', '$pneu17', '$pneu18', '$pneu19', '$pneu20', '$pneu21', '$pneu22') "; 
                                    
                    try {
                        if ($banco->query($q)) {
                            echo msg_sucesso("Veículo cadastrado com sucesso!");
                        ...
                        echo "<p>Não foi possível cadastrar o veículo. Tente novamente!.</p>";
                        echo $e->getMessage();
                    }
                }
