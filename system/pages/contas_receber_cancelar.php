        ...
        <?php 
            ...
            echo msg_erro('Área restrita. Você não é administrador!');
                ...
                if (isset($_GET['id'])) {
                    ...
                    $q = "UPDATE contas_receber SET situacao = 'Cancelada' WHERE id = $id";

                    try {
                        if ($banco->query($q)) {
                            echo msg_sucesso("Viagem cancelada com sucesso!");
                            echo "
                                <div class='container'>
                                    <a href='viagens.php'>
                        ...
                        echo "<p>Não foi possível cancelar a viagem. Tente novamente! " . $e->getMessage() . "</p>";
                        echo "
                            <div class='container'>
                                <a href='viagens.php'>
                                    <input type='submit' value='Voltar' class='btn btn-outline-primary'>
