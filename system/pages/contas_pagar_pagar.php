        ...
        <?php 
            ...
            echo msg_erro('Área restrita. Você não é administrador!');
                ...
                if (isset($_GET['id'])) {
                    ...
                    $q = "UPDATE contas_pagar SET tipo_pagamento = '$tipo_pagamento', valor_pago = '$valor_pago', situacao = 'Pago', data_pagamento = current_timestamp() WHERE id = '$id'";

                    
                    try {
                        if ($banco->query($q)) {
                            echo msg_sucesso("Conta paga com sucesso!");
                            echo "
                                <div class='container'>
